      ...
      <div class="rounded-lg p-6 w-9/12">
        <div class="flex items-center mb-6 ">
          <div class="h-28 rounded-lg mr-8 flex-shrink-0">
            <img :alt="sponsor.name" :src="getImagePath(sponsor.image)"
        ...
        <div v-if="sponsor.recruitment" class="my-6">
          ...
          <div class="flex items-center mb-6 ">
            <div v-if="sponsor.recruitment.image" class="h-36 rounded-lg mr-8 flex-shrink-0">
            ...
            <div class="flex-grow text-white">
              ...
              <ul>
                <li v-for="u in sponsor.recruitment.url">
                 - <a :href="u" class="text-blue-200 ml-2" target="_blank">{{ u }}</a>
                </li>
              </ul>
            </div>
          </div>
