...
const speakersData: speakerModel[] = [
    ...
    },
    {
        id: 'James',
        name: 'James Wang',
        image: 'speaker-James.png',
        epic: '知識精煉：運用社會技術來解決遺留系統中的管理挑戰',
        bio: ['一位熱衷於探索新知並樂於分享的軟體開發工程師。同時也擔任台灣領域驅動設計社群的核心志工。'],
        intro: ['大家好，我是 James Wang，一位熱衷於探索新知並樂於分享的軟體開發工程師。同時，我也擔任台灣領域驅動設計社群的核心志工。',
            '我是軟體開發工程師，但說實在的，我不特別喜歡繁複且耗時的程式編寫工作。我深信，工程師的一種美德就是「懶」——沒錯，你聽得沒有錯。因為我們不願做重複性的工作，所以我們持續尋找提高效率的方法。因此，我一直努力學習並實踐各種能讓開發更有效率、更輕鬆的方法論，例如領域驅動設計、敏捷開發和 DevOps。',
